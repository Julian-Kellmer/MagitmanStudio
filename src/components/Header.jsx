...
const Header = () => {
  ...
  return (
    <>
      <header className='fixed top-0 left-0 right-0 z-50 layout-wrap py-4 flex items-center justify-between bg-background transition-colors duration-300'>

...
const Footer = () => {
  return (
    <footer className='layout-wrap bg-[#fdf6f3] pt-12 md:pt-24 pb-8 border-t border-black/5'>
      <div className='layout-grid col-span-full bg-tertiary/30 pt-12 md:pt-24 pb-8 px-4 md:px-8 rounded-lg'>
        {/* Top Section: Logo & Title */}
        <div className='col-span-full flex flex-col items-center justify-center gap-4 md:gap-6 mb-12 md:mb-24'>
          <img
            src='/isotipo.svg'
        ...
        <div className='col-span-full grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-4 mb-12 md:mb-24'>
          {/* Left: Navigation */}
          ...
          <div className='md:col-span-6 flex flex-col items-center text-center gap-6 md:gap-8'>
            ...
            <div className='flex flex-col gap-1'>
              <h4 className='text-base md:text-lg font-medium mb-1'>Estudio</h4>
              <p className='text-sm md:text-body text-black/60'>
                Belgrano CABA,
              </p>
              <p className='text-sm md:text-body text-black/60'>Cabildo 4367</p>
            </div>
          </div>
